...
const ProfilePage = () => {
  ...
  const Handler = (e) => {
    ...
    setProfileData((prevState) => ({
      ...
      ModelDetails: {
        ...
        // [e.target.TELENT]: checked
        //   ? [...prevState.ModelDetails.TELENT, value] // Add value if checkbox is checked
        //   : Object.argumentsprevState.ModelDetails.TELENT.filter((item) => item !== value), // Remove value if checkbox is unchecked
      },
    }));
  ...
  const MySubmit = (e) => {
    ...
    for (const TELENT in profileData.ModelDetails.TELENT) {
      if (profileData.ModelDetails.TELENT[TELENT]) {
        formData.append("TELENT", profileData.ModelDetails.TELENT[TELENT]);
      }
    }
    axios
      .post(
        "https://projects.seawindsolution.com/MODEL/Webservices/updateProfile",
        formData,
        {
          headers,
        }
