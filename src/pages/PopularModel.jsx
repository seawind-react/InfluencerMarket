...
const PopularModelPage = () => {
  ...
  //   const response = await fetch(`https://projects.seawindsolution.com/MODEL/Webservices/getProfile/${ID}`);
    ...
    <section className="pt-md-5 pb-md-5 mt-md-5 mb-md-5 custom-section">
      <Container>
        <div className="page-title text-center">
          <h2 className="m-0">Popular Models</h2>
                ...
                <>
                  <div className="models-box">
                    ...
                    <div className="overlay">
                      <div className="block-model-name"><a href="https://www.projects.seawindsolution.com/MODEL/model-detail/Alisha">{value.name}</a></div>
        ...
        <Row>
          <Col xs="12" className="text-center mt-5">
            <div className="custom-btn">
              <a
                href="https://www.projects.seawindsolution.com/MODEL/model"
...
export default PopularModelPage;
